...
import com.m.emad.beinmedia.BuildConfig;
import com.m.emad.beinmedia.data.source.network.ApiClient;
import com.m.emad.beinmedia.data.source.network.CommonHeadersAttachingInterceptor;
import com.m.emad.beinmedia.data.source.network.CommonParamsAttachingInterceptor;
import com.m.emad.beinmedia.data.source.network.RequestConfig;
...
public class RequestManager {
    ...
    @Inject
    public RequestManager(UserManager userManager) {
    ...
    public RequestConfig generateRequestConfig() {
        ...
        /*if (userManager.getCurrentSession() != null) {
            commonConfig.addHeader("Authorization", String.valueOf(userManager.getCurrentSession().getId()));
        }*/
